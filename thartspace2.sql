...
--
-- Host: localhost
-- Generation Time: Jul 22, 2013 at 09:57 AM
...
(1, 1, 1, 'Untitled 1', 'Little Gem - I have painted a small series of Original Oil Paintings that are 5x8in and are matted with a A3 slightly off white matt. I haven''t framed this series as it is easier this way for postage. They are oil paintings so do not need to be frame', '2005', 'Oil on Canvas', '350 x 650mm', 'SOLD', 0, 'artworks/painting1.jpg', 0),
(2, 1, 1, 'Untitled 2', '', '2002', 'Oil on Canvas', '450 x 853mm', 'For Sale', 3000, 'artworks/painting2.jpg', 0),
(3, 2, 2, 'Agree to Differ', 'On the theme of doubt and dogma, "Agree to differ" offers an interesting variety of installation options - on a flat surface, hanging on a wall and the two parts placed in differing orientation to each other ', '1998', 'Copper and Wire', '1000 x 650mm', 'For Sale', 2500, 'artworks/sculpture1.jpg', 0),
(4, 2, 2, 'Human Landscape 3', '''Human Landscape 3'' was created by my fascination for the New Zealand landscape, the volcanos and mountains that look like human forms. This sculpture is a one-off unique and solid bronze. ', '2003', 'Solid bronze', '1200 x 1450mm', 'SOLD', 0, 'artworks/sculpture2.jpg', 0),
(5, 3, 3, 'Location', 'Photograph used for a location shot for outdoor shoot. 2010 ', '2010', 'Black and White digital print', '841 x 594mm', 'For Sale', 650, 'artworks/photography1.jpg', 0),
(6, 3, 3, 'Theatre pose', 'Contemporary makeovers captured. Studio work available to includes Makeup and styling ,includes set of prints.Book a shoot in our studio. ', '2013', 'Digital colour print', '841 x 594mm', 'SOLD', 0, 'artworks/photography2.jpg', 0),
(7, 4, 6, 'Bay of Island Pohutukawa Trees in Autumn', 'This Giclee Reproduction is printed onto canvas and is studio wrapped.   This painting was selected and published in a New Zealand calendar. ( price does not include postage) ', '2013', 'Giclee Reproduction', '810 x 530mm', 'For Sale', 895, 'artworks/print1.jpg', 0),
(8, 4, 6, 'Hands', 'Prints Available to purchase also at Terrace Downs Resort until August 1. Size of Limited ed Giclee (50) print Size: 1300 x 865 Price: $600 or Size: 90 x 60 Price: $360 ', '2012', 'Original Giclee Print', '600 x 900mm', 'For Sale', 740, 'artworks/print2.jpg', 0),
(9, 5, 7, 'Golden Love', '', '2013', 'Mixed media on board', '760 x 610mm', 'SOLD', 0, 'artworks/mixedmedia1.jpg', 0),
(10, 5, 7, 'From Land to Sea', 'This Triptych of three panels from the Periodic Table has a beautiful aged appearance. All symbols have been painted in Graphite Grey, with the names of each colour applied in it''s ''like'' colour...', '2009', 'Pencil and Ink on paper', '530 x 680 mm', 'SOLD', 0, 'artworks/mixedmedia2.jpg', 0),
(11, 6, 5, 'Kauaeranga Dam', '', '2008', 'Conte on paper', '297 x 420mm', 'For Sale', 250, 'artworks/drawing1.jpg', 0),
(12, 6, 5, 'Blue Jug and Lemons', 'Still life pastel drawing', '2013', 'Pastel on cotton rag', '360 x 540mm', 'For Sale', 360, 'artworks/drawing2.jpg', 0),
(13, 7, 4, 'Kutae Ring', 'large and funky pounamu,s/s', '2012', 'Greenstone and silver', '30 x 40mm', 'SOLD', 0, 'artworks/jewellery1.jpg', 0),
(14, 7, 4, 'Wheku Haere', 'Wheku Haere. Made for exhibition and show for Matariki celebrations in Napier 2008. Exhibited at Toimairangi in Hastings and Fashion Showcase at Brookfield wineries, Napier 13 July 2008. Materials, 10 cent coin peirced, sterling silver, black pearls', '2008', 'Sterling silver, black pearl shell ', '300 x 100mm', 'For Sale', 600, 'artworks/jewellery2.jpg', 0),
(15, 8, 8, 'Industrial Lace', '', '2013', 'Found materials', '200 x 400mm', 'For Sale', 380, 'artworks/other1.jpg', 0),
(16, 8, 8, 'Botanical Industrial', 'Amazing work can used in a series of work All sizes.Botanical series ', '2011', 'Digital Artwork - gloss print', '450 x 700mm', 'SOLD', 0, 'artworks/other2.jpg', 0),
(23, 2, 9, 'True ', 'Al Bae', '1987', '', '156x154', 'For Sale', 3500, 'artworks/1374217323.jpg', 0);
...
INSERT INTO `tbexhibition` (`ExhibitionID`, `ArtistID`, `ExhibitionTitle`, `StartDate`, `EndDate`, `ExhibitionDescription`) VALUES
(1, 5, 'Really Nice Art', '10.12.13', '17.12.13', 'Really Nice Art by Me'),
(2, 5, 'Really Nice Art', '10.12.13', '17.12.13', 'Really Nice Art by Me');
...
INSERT INTO `tbexhibitwork` (`ExhibitworkID`, `ExhibitionID`, `ArtworkID`) VALUES
(1, 1, 5),
(2, 2, 15),
(3, 1, 10),
(4, 2, 6);
